...
/**
 * p_type - It prints the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
...
/**
 * p_entry - It prints the entry point of an ELF header.
...
/**
 * main - It displays the information of the
 *        ELF header.
